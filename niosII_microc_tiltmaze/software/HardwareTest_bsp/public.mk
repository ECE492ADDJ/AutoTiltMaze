...
JDI_FILE := $(ABS_BSP_ROOT_DIR)/../../niosII_microc_tiltmaze.jdi
...
# setting SOPC_SYSID_BASE_ADDRESS is 0x110a060
SOPC_SYSID_FLAG += --sidp=0x110a060
ELF_PATCH_FLAG  += --sidp 0x110a060

# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1486849659
SOPC_SYSID_FLAG += --timestamp=1486849659
ELF_PATCH_FLAG  += --timestamp 1486849659
